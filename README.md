...
+ Guides
    + [Bento](https://www.bento.io/): a collection of guides for web development.
    + [Hack Design](http://hackdesign.org/lessons): An easy to follow design course for people who do amazing things.
    ...
    + [Talks To Help You Become A Better Front-End Engineer In 2013](http://www.smashingmagazine.com/2012/12/talks-to-help-you-become-a-better-front-end-engineer-in-2013/)
    ...
    + [Treehouse](https://teamtreehouse.com/): Learn HTML, CSS, iPhone apps and more.
...
+ Architecture
    ...
    + [BEM](https://en.bem.info/): Methodology aimed at achieving fast to develop long-lived projects, team scalability, and code reuse.
        ...
        + [Introductory article on Smashing Magazine](http://www.smashingmagazine.com/2012/04/a-new-front-end-methodology-bem/)
        + [Video: How to use BEM! outside of Yandex](https://vimeo.com/38346573)
    + [Atomic Design](http://bradfrost.com/blog/post/atomic-web-design/)
        + [Slides](http://www.slideshare.net/bradfrostweb/atomic-design)
        + [Pattern Lab](http://patternlab.io/)
    + [Polymer Project](https://www.polymer-project.org/): Polymer is a library that uses the latest web technologies to let you create custom HTML elements.
    ...
    + [Video: Nicholas Zakas: Scalable JavaScript Application Architecture](https://www.youtube.com/watch?v=vXjVFPosQHw)
    ...
    + [Book: Scalable and Modular Architecture for CSS](https://smacss.com/book/)
...
+ Workflow
    ...
    + [Grunt](http://gruntjs.com/) is a task-based command line build tool for JavaScript projects.
        + [Web development is getting complex. Let's go shopping.](http://ruudud.github.io/2012/12/22/grunt/)
        ...
        + [A beginner’s guide to Grunt](http://mattbailey.io/a-beginners-guide-to-grunt/)
        + [Grunt - Synchronised Testing Between Browsers/Devices](http://mattbailey.io/grunt-synchronised-testing-between-browsers-devices/)
    + [Gulp](http://gulpjs.com/) is a build system that makes use of node's streams.
        ...
        + [The vision, history, and future of the project](https://medium.com/@contrahacks/gulp-3828e8126466)
        + [Managing Your Build Tasks With Gulp.js](http://code.tutsplus.com/tutorials/managing-your-build-tasks-with-gulpjs--net-36910)
    + [Mod](https://github.com/modjs/mod) is a task-based workflow tooling for web, it help developers quickly build robust and high-performance web applications.
    ...
    + [Browser-sync](https://github.com/BrowserSync/browser-sync): is a tool to sync all input, scrolling, and clicking across all the devices in your testing workflow.
    + [Video: JavaScript Development Workflow of 2013 by Paul Irish](https://www.youtube.com/watch?v=f7AU2Ozu8eo) + [Slides](https://dl.dropboxusercontent.com/u/39519/talks/fluent/index.html)
+ Podcasts
	 + [Shoptalk Show](http://shoptalkshow.com/) A podcast about web design, development and UX.
	 + [Javascript Jabber](https://devchat.tv/js-jabber/) A podcast all about Javascript
	 ...
	 + [SassCast](http://www.podbean.com/site/error) A podcast all about the Sass preprocessor.
...
+ Programming & Markup Languages
    ...
    + JavaScript
        + [Book: Eloquent JavaScript](http://eloquentjavascript.net/1st_edition/contents.html)
        ...
        + Flow Control
            ...
            + [Video by Douglas Crockford on monads which is touching Promises](https://www.youtube.com/watch?v=dkZFtimgAcM)
            ...
            + Libraries
                + [Standalone-Deferred](https://github.com/warpdesign/deferred-js)
                + [Standalone-Deferred](https://github.com/Mumakil/Standalone-Deferred)
                + [Flowy](https://github.com/maslennikov/node-flowy)
                + [Step](https://github.com/creationix/step)
                + [kew](https://github.com/Medium/kew) is a lightweight promise library optimized for node.js
    ...
    + Higher Level Languages
        + [Dart](https://www.dartlang.org/): Typed language compiled to JavaScript. By Google.
    ...
    + JavaScript
        ...
        + [Angular](https://angularjs.org/)
            ...
            + Learning
                ...
                + [AngularJS Screencasts](https://egghead.io/)
        ...
        + [jQuery](http://jquery.com/)
            ...
            + [jQuery Wiki Page "Plugins/Authoring"](http://learn.jquery.com/plugins/)
            + [The Ultimate Guide to Writing jQuery Plugins](http://www.websanova.com/the-ultimate-guide-to-writing-jquery-plugins)
            + [Book: jQuery Fundamentals](http://jqfundamentals.com/)
            + [Pragmatic jQuery Style](https://github.com/yuanyan/pragmatic-jquery)
            + [Handpicked jQuery Plugins](http://www.jque.re/)
        ...
        + [Backbone](http://backbonejs.org/)
            ...
            + [Book: Developing Backbone.js Applications](http://addyosmani.github.io/backbone-fundamentals/)
        ...
        + [Meteor](https://www.meteor.com/): An open-source platform for building top-quality web apps in a fraction of the time.
        ...
        + [Singool.js](http://fahad19.github.io/singool/) Lightweight JavaScript framework for developing single-page web applications
        ...
        + [Synapse](http://bruth.github.io/synapse/docs/): Data Binding For The Rest Of Us
        ...
        + [JavaScript Data Binding Frameworks](http://weblogs.asp.net/dwahlin/javascript-data-binding-frameworks)
    ...
    + CSS
        ...
        + Bootstrap
            ...
            + Widgets
                ...
                + [WYSIHTML5 RTE for Bootstrap](http://jhollingworth.github.io/bootstrap-wysihtml5/)
                + [Bootstrap Image Gallery](http://blueimp.github.io/Bootstrap-Image-Gallery/)
                + [fuelUX](http://exacttarget.github.io/fuelux/): Fuel UX extends Twitter Bootstrap with additional lightweight JavaScript controls.
                + [A date range picker for Twitter Bootstrap](http://www.daterangepicker.com/)
                + [Bootbox.js](http://bootboxjs.com/): alert, confirm and flexible dialogs for Twitter's Bootstrap framework
                + [Time Picker](http://jdewit.github.io/bootstrap-timepicker/)
                ...
                + [File Upload](http://www.jasny.net/bootstrap/javascript/)
                ...
                + [Slider](http://ghusse.github.io/jQRangeSlider/)
                + [Application Wizard](https://github.com/amoffat/bootstrap-application-wizard)
            + Themes
                + [Bootswatch](http://bootswatch.com/): Theme catalog.
                + [Bootstrap Zero](https://www.bootstrapzero.com): Get a less Bootstrap-y look with these custom themes
                + [Jumpstart UI](http://jumpstartui.com/index.html): Another catalog for paid themes
                ...
                + [Facebook](http://ckrack.github.io/fbootstrapp/)
                + [Google+](http://xbreaker.github.io/plusstrap/index.html)
                + [Flatstrap](http://ww2.littlesparkvt.com)
            ...
            + Misc
                ...
                + [Bootstrap GUI PSD](http://store.repixdesign.com/): a toolkit designed to kickstart webdesign of webapps and sites.
                ...
                + [TODC](http://todc.github.io/todc-bootstrap/index.html): A Google-styled theme for Twitter Bootstrap.
        ...
        + [Pondasee](http://tokokoo.github.io/pondasee/): Front-end starter kit combined with the power of SCSS & Compass.
        + [Foundation by Zurb](http://foundation.zurb.com/): The most advanced responsive front-end framework in the world.
                + [Foundation 3 Documentation](http://foundation.zurb.com/docs/v/3.2.5/)
...
+ Cross Browser
    ...
    + [Outdated Browser](http://outdatedbrowser.com/en) - Checks if user's browser is outdated and suggests downloading latest.
+ Cross Device
    + Responsive
        + [Responsive Boilerplate](http://responsiveboilerplate.com/): A starting point to responsive web design!
        + [Video: Responsive Design Workflow by Stephen Hay](https://vimeo.com/45915667) + [Slides](http://de.slideshare.net/stephenhay/mobilism2012)
        ...
        + Images
            ...
            + [resrc.it](https://www.resrc.it/): Responsive images on demand from the cloud.
        + Text
    ...
    + E-Mail
        + [Responsive Email Design](https://www.campaignmonitor.com/dev-resources/guides/mobile/): A great guide to create Responsive Email Design
        + [Responsive Email Templates](http://zurb.com/playground/responsive-email-templates): Some responsive templates for email
        + [Ink by Zurb](http://foundation.zurb.com/emails.html): An awesome responsive email framework from the folks at Zurb.
    ...
    + Mobile
        + Frameworks
            ...
            + [jQTouch](http://jqtjs.com/) is a Zepto/jQuery plugin for mobile web development on the iPhone, Android, iPod Touch, and other forward-thinking devices.
            + [Junior](http://justspamjustin.github.io/junior/)
        + Emulators
        ...
        + Scrolling
            ...
            + [Overscroll](http://ww1.azoffdesign.com) is a jQuery plug-in that mimics the iphone/ipad scrolling experience in a browser.
            + [Zynga Scroller](https://github.com/zynga/scroller)
            + [pull-to-refresh.js](https://github.com/visiongeist/pull-to-refresh-js)
        ...
        + Gestures
            ...
            + [hammer.js](http://eightmedia.github.io/hammer.js/) is a focused, standalone JavaScript library, only for multi-touch gestures.
            ...
            + [toe.js](https://github.com/visiongeist/toe.js) is a tiny library based on jQuery to enable sophisticated gestures on touch devices.
        ...
        + Tap Acceleration
            ...
            + [Tappable](http://cheeaun.github.io/tappable/) is a simple, standalone library to invoke the tap event for touch-friendly web browsers.
            ...
            + [Creating Fast Buttons for Mobile Web Applications](https://developers.google.com/)
        + Layout
            + [Screensizes](http://screensiz.es/phone)
            ...
            + [Swipe](https://github.com/thebird/swipe) is a lightweight mobile slider with 1:1 touch movement, resistant bounds, scroll prevention, and completely library agnostic.
            + [Swiper](http://www.idangero.us/swiper/): Mobile touch slider with hardware accelerated transitions.
            ...
            + [stackable.js](http://johnpolacek.github.io/stacktable.js/) is an invaluable jQuery plugin that stacks your tables for small screens. It’s a huge advantage in terms of usability on mobile devices.
        ...
        + iOS
            ...
            + [Targeting the iPhone 4 Retina Display with CSS3 Media Queries](https://www.iwalt.com/weblog/2010/06/targeting-the-iphone-4-retina-display-with-css3-media-queries)
            ...
            + [jQuery Retina Display Plugin](http://mcilvena.com/articles/jquery-retina/)
            + [retina.js](http://imulus.github.io/retinajs/)
            + [Retina Images](http://retinaimag.es/)
    + Printers
        + [Tips And Tricks For Print Style Sheets](http://www.smashingmagazine.com/2013/03/tips-and-tricks-for-print-style-sheets/)
+ Patterns & Snippets
    + [Responsive Patterns](http://bradfrost.github.io/this-is-responsive/patterns.html)
    + [CSS3 Code Snippets](http://www.cssflow.com/snippets/)
...
+ Typography
    ...
    + [Adobe Edge Web Fonts](https://edgewebfonts.adobe.com/): Get started with free web fonts.
    ...
    + [Typeset.css](http://joshuarudd.github.io/typeset.css/)
    ...
    + [jKerny](http://behaba.com/assets/jkerny/)
...
+ Services (Free & Commercial)
    ...
    + [Color Scheme Designer](http://paletton.com/): find resonate colors for a great design.
    + [Adobe Kuler](https://color.adobe.com/): create and share color schemes.
    + [HTML Entity Character Lookup](http://entity-lookup.leftlogic.com)
    ...
    + [Zen BG](http://galacticmilk.com/bg/)
    ...
    + [GenyMotion](https://www.genymotion.com/) is the next generation of the AndroVM open source project, already trusted by 900,000 developers.
    + [Website Builders](https://en.wikipedia.org/wiki/Website_builder)
        ...
        + [Webnode](http://us.webnode.com/)
        + [Webs](http://www.webs.com/)
        + [Weebly](http://www.weebly.com/)
        + [Wix](http://www.wix.com)
        + [Wordpress.com](https://wordpress.com/)
        + [Yola](https://www.yola.com/)
        + [1&1 Homepage](http://hosting.1und1.de/homepage-erstellen?)
+ Animation
    + [Velocity.js](http://julian.com/research/velocity/): Re-implementation of jQuery's $.animate() that adds 20x the speed while also drastically improving the UI animation workflow.
    ...
    + [Canvas Advanced Animation Toolkit](http://hyperandroid.github.io/CAAT/) is an scene graph director-based animation framework for javascript based in the concept of a timeline.
    + [tween.js](https://github.com/tweenjs/tween.js): Super simple, fast and easy to use tweening engine which incorporates optimised Robert Penner's equations.
    ...
    + [GreenSock Animation Platform](http://greensock.com/get-started-js) is a suite of tools for scripted animation.
        + [Learning Resources](http://greensock.com/learning/)
    ...
    + [Animator.js](http://blog.berniesumption.com/software/animator/): JavaScript animation library.
...
+ Widgets
    + Kits
        + [AlloyUI](http://liferay.github.io/alloyui.com/)
    ...
    + Table Of Contents
        ...
        + [MagicNav.js](http://johnpolacek.github.io/MagicNav.js/)
        + [jQuery TOC](http://projects.jga.me/toc/)
    + Modals
        + [Avgrund](http://lab.hakim.se/avgrund/)
        + [Timeout Dialog](http://rigoneri.github.io/timeout-dialog.js/)
    ...
    + Notifications
        ...
        + [Apprise](http://labs.bigroomstudios.com/libraries/Apprise-v2)
    + Gallery Sliders
        + [Sequence](http://www.sequencejs.com/)
        + [Rhinoslider](http://www.rhinoslider.com/)
    ...
    + Selects
        ...
        + [jquery.selectable.js](http://endel.me/jquery.selectable.js/)
...
+ Visualization
    ...
    + [D3.js](http://d3js.org/)
        ...
        + [Interactive D3 Tutorial](http://vadim.ogievetsky.com/IntroD3/)
        + [NVD3](http://nvd3.org/)
    ...
    + [Piecon](http://lipka.github.io/piecon/)
    + [Viskit.js](http://wso2.github.io/viskit/)
    + [jStat](https://github.com/jstat/jstat)
    + [CHAP Links Library](http://almende.github.io/chap-links-library/index.html)
    ...
    + [xCharts](http://tenxer.github.io/xcharts/) is a JS library for creating attractive, custom data-driven chart visualizations. It uses HTML, CSS, and SVG to create dynamic, fluid charts that can be easily customized and integrated.
    ...
    + [GoJS](http://gojs.net/latest/index.html): Library for creating interactive diagrams (Trees, flowcharts, state charts, etc) in the browser.
...
+ Validation & Forms
    ...
    + [mailcheck.js](https://github.com/mailcheck/mailcheck): A jQuery plugin that suggests a right domain when your users misspell it in an email address.
    ...
    + [nextVal](http://jukebox42.github.io/nextVal/) is an easy-to-use, flexible and robust form validation plugin for jQuery.
    + [Fields.js](http://schneiderik.github.io/fields/) creates collections of fields. Each field is constantly evaluated for validity, and is accessible through the collection.
    + [IV.js](http://dadleyy.github.io/IV.js/) was created to provide a intutive way to provide validation filters that are useful in processing user input.
...
+ Testing
    + [BrowserStack] (https://www.browserstack.com/start) Comprehensive range of Browsers & Mobile Emulators available online for Live Testing and ready to use.
...
+ Template Engines
    ...
    + [Templayed.js](http://archan937.github.io/templayed.js/)
    ...
    + [Nunjucks](http://jlongster.github.io/nunjucks/) is a full featured templating engine for javascript.
    + [Jade](http://jade-lang.com/)
    + [Linked.in Dust.js](http://linkedin.github.io/dustjs/)
        + [The client-side templating throwdown: mustache, handlebars, dust.js, and more](https://engineering.linkedin.com/frontend/client-side-templating-throwdown-mustache-handlebars-dustjs-and-more)
        + [Leaving JSPs in the dust: moving LinkedIn to dust.js client-side templates](https://engineering.linkedin.com/frontend/leaving-jsps-dust-moving-linkedin-dustjs-client-side-templates)
        + [Tutorial](https://github.com/linkedin/dustjs/wiki/Dust-Tutorial)
        + [Testing Console](http://linkedin.github.io/dustjs/test/test.html)
+ Routing And URLs
    ...
    + [path.js](http://mtrpcic.github.io/pathjs/)
...
+ Rich Text Editors
    ...
    + [Substance Composer](https://github.com/substance/substance-legacy)
    + [Proper](https://github.com/michael/proper)
    + [SnapEditor](http://www.snapeditor.com/)
    + [Create.js](http://createjs.org/)
    + [MDMagick](http://fguillen.github.io/MDMagick/)
...
+ Code Viewers & Editors
    ...
    + [tabIndent.js](http://julianlam.github.io/tabIndent.js/)
...
+ Performance
    + General Information
        + [Video: DOM, HTML5, & CSS3 Performance](http://www.paulirish.com/2011/dom-html5-css3-performance/) by Paul Irish
        + [Video: High Performance JavaScript](https://vimeo.com/16241085) by Nicholas Zakas
    ...
    + Tools
        ...
        + [Chrome Developer Tools](https://developer.chrome.com/devtools/)
            ...
            + [Profiles Panel](https://developer.chrome.com/devtools/docs/profiles)
            + [JavaScript Profiling With The Chrome Developer Tools](http://www.smashingmagazine.com/2012/06/javascript-profiling-chrome-developer-tools/)
        ...
        + [Locache](https://github.com/d0ugal-archive/locache): JavaScript caching framework for client side caching in the browser using localStorage
        + [Caliper](http://www.caliper.io) is a web service for performance monitoring of your web app.
    + DOM Manipulation
        ...
        + [Speeding up JavaScript: Working with the DOM](https://developers.google.com/speed/articles/reflow)
    ...
    + Browser Internals
        + [Video: Google I/O 2012 - Breaking the JavaScript Speed Limit with V8](https://www.youtube.com/watch?v=UJPdhx5zTaw) by Daniel Clifford
        + [Video: Faster HTML and CSS: Layout Engine Internals for Web Developers](https://www.youtube.com/watch?v=a2_6bGNZ7bA): by David Baron of Mozilla
        ...
        + [Video: GDC 2012: From Console to Chrome](https://www.youtube.com/watch?v=XAqIpGU8ZZk)
        ...
        + [Video: Alex Russell - Life Of A Button Element](https://vimeo.com/32364192)
        + [How a web page loads](http://gent.ilcore.com/2011/05/how-web-page-loads.html)
        + [Video: The Fundamentals, Primitives and History of HTML5](http://www.paulirish.com/2011/primitives-html5-video/)
    ...
    + Images
        ...
        + [Clever JPEG Optimization Techniques](http://www.smashingmagazine.com/2009/07/clever-jpeg-optimization-techniques/)
        + [Clever PNG Optimization Techniques](http://www.smashingmagazine.com/2009/07/clever-png-optimization-techniques/)
        + [How to Optimize PNG and JPEG without Quality Loss](http://mag.splashnology.com/article/how-to-optimize-png-and-jpeg-without-quality-loss-part-1/2071/) + [Part 2](http://mag.splashnology.com/article/how-to-optimize-png-and-jpeg-without-quality-loss-part-2/2568/)
    + HTTP Transport
        ...
        + [Video: Cache Is King!](https://www.youtube.com/watch?v=HKNZ-tQQnSY) by Steve Souders
...
+ Modularity & Loaders
    ...
    + [Modular JavaScript with RequireJS](https://www.credera.com/blog/custom-application-development/modular-javascript-with-requirejs/)
    + [LABjs & RequireJS: Loading JavaScript Resources the Fun Way](https://msdn.microsoft.com/en-us/magazine/ff943568.aspx)
...
+ Icons
    ...
    + [Font Awesome](http://fortawesome.github.io/Font-Awesome/): The iconic font designed for use with Twitter Bootstrap
...
+ WebSocket
    ...
    + [engine.io](https://github.com/socketio/engine.io) is the implementation of transport-based cross-browser/cross-device bi-directional communication layer for Socket.IO.
...
+ Error Handling & Debugging
    ...
    + [JavaScript error handling anti-pattern](https://www.nczonline.net/blog/2009/04/28/javascript-error-handling-anti-pattern/)
    + [Tattletale](https://github.com/vimeo/tattletale.js)
...
+ Windows 8 Style
    ...
    + [Metro UI Template](http://metro-webdesign.info/mobile.php)
    ...
    + [CSS3 Microsoft Modern Buttons](http://acesubido.com/css3-microsoft-metro-buttons/index.html)
    + [Visual Studio 2012 Image Library - 5,000+ Images Downloadable Now](https://dzone.com/articles/visual-studio-2012-image)
...
+ Video & Audio
    + [SublimeVideo](http://www.sublimevideo.net): Modular Video Player Framework.
    + [Video.js](http://videojs.com/): The open source HTML5 video player.
    + [FlowPlayer](https://flowplayer.org/): The video player for the web.
    + [longtailVideo](http://www.jwplayer.com/): dual-mode HTML5 & Flash player.
    + [howler.js](http://goldfirestudios.com/blog/104/howler.js-Modern-Web-Audio-JavaScript-Library)
    + [Stratus 2](https://stratus.soundcloud.com) soundcloud player
...
+ Library Collections
    ...
    + [JSDB.io](http://www.javascripting.com/): great source of the best JavaScript frameworks, plugins, and tools.
...
+ Chat
    ...
    + [Converse.js](https://conversejs.org/) is an open source, webchat client, that runs in the browser and can be integrated into any website.
+ Prototyping
    + [RoughDraft.js](https://github.com/ndreckshage/roughdraft.js)
    + [Video: Style guides are the new Photoshop by Stephen Hay](https://vimeo.com/52851510) + [Slides](http://de.slideshare.net/stephenhay/style-guides-are-the-new-photoshop-fronteers-2012)
    + [fixie](https://github.com/ryhan/fixie)
    + [Holder.js](http://imsky.github.io/holder/)
+ JSON
    + [JSON Query Language](http://www.jsoniq.org/) is a query and processing language specifically designed for the popular JSON data model.
...
+ Presentations
    ...
    + [Slideshow.html](http://dmfrancisco.github.io/slideshow.html/)
...
+ Scrolling
    ...
    + [FoldScroll](http://soulwire.github.io/FoldScroll/)
    + [Scrollorama](http://johnpolacek.github.io/scrollorama/)
+ Keyboard
    + [Mousetrap](https://craig.is/killing/mice)
    + [Keypress](http://dmauro.github.io/Keypress/)
    + [konami.js](http://mckamey.github.io/konami-js/)
...
+ Tables & DataGrids
    ...
    + [Backgrid.js](http://wyuenho.github.io/backgrid/)
    + [Gridster](http://gridster.net/)
    + [Flex](http://www.jsonenglish.com/projects/flex/)
    + [grid-list](https://github.com/hootsuite/grid)
+ Security
    + [oAuth Consumer Library](http://oauth.googlecode.com/svn/code/javascript/) by John Kristian
     + [ohauth](https://github.com/gijs/ohauth)
        + [How iD Logs in to OpenStreetMap](https://www.mapbox.com/osmdev/2013/01/15/oauth-in-javascript/)
    ...
    + [JavaScript Crypto Library](https://clipperz.is/open_source/javascript_crypto_library/)
    + [Stanford JavaScript Crypto Library](https://crypto.stanford.edu/sjcl/)
    + [mozilla / jwcrypto](https://github.com/mozilla/browserid-crypto)
    + Critic
...
+ Jobs & Hiring
    ...
    + [37signals Job Board](https://weworkremotely.com)
...
+ Misc
    ...
    + [Lo-Dash](https://lodash.com/) - A low-level utility library delivering consistency, customization, performance, and extra features.
